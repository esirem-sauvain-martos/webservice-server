...
#include "soapH.h"
    ...
    class SOAP_CMAC agentProxy {
      public:
        ...
        agentProxy();
        /// Copy constructor
        agentProxy(const agentProxy& rhs);
        /// Construct proxy given a shared managing context
        agentProxy(struct soap*);
        /// Construct proxy given a shared managing context and endpoint URL
        agentProxy(struct soap*, const char *soap_endpoint_url);
        /// Constructor taking an endpoint URL
        agentProxy(const char *soap_endpoint_url);
        /// Constructor taking input and output mode flags for the new managing context
        agentProxy(soap_mode iomode);
        /// Constructor taking endpoint URL and input and output mode flags for the new managing context
        agentProxy(const char *soap_endpoint_url, soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        ...
        virtual agentProxy *copy();
        /// Copy assignment
        agentProxy& operator=(const agentProxy&);
