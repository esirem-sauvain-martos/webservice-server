...
{	this->soap = soap_new();
	this->soap_own = true;
	managerService_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
}

managerService::managerService(const managerService& rhs)
{	this->soap = rhs.soap;
	this->soap_own = false;
}

managerService::managerService(struct soap *_soap)
{	this->soap = _soap;
	this->soap_own = false;
	managerService_init(_soap->imode, _soap->omode);
}

managerService::managerService(soap_mode iomode)
{	this->soap = soap_new();
	this->soap_own = true;
	managerService_init(iomode, iomode);
}

managerService::managerService(soap_mode imode, soap_mode omode)
{	this->soap = soap_new();
	this->soap_own = true;
	managerService_init(imode, omode);
}
...
void managerService::managerService_init(soap_mode imode, soap_mode omode)
...
void managerService::destroy()
{	soap_destroy(this->soap);
	soap_end(this->soap);
}

void managerService::reset()
{	this->destroy();
	soap_done(this->soap);
...
managerService *managerService::copy()
{	managerService *dup = SOAP_NEW_UNMANAGED(managerService);
	if (dup)
	{	soap_done(dup->soap);
...
managerService& managerService::operator=(const managerService& rhs)
...
int managerService::soap_close_socket()
{	return soap_closesock(this->soap);
}

int managerService::soap_force_close_socket()
{	return soap_force_closesock(this->soap);
}

int managerService::soap_senderfault(const char *string, const char *detailXML)
{	return ::soap_sender_fault(this->soap, string, detailXML);
}

int managerService::soap_senderfault(const char *subcodeQName, const char *string, const char *detailXML)
{	return ::soap_sender_fault_subcode(this->soap, subcodeQName, string, detailXML);
}

int managerService::soap_receiverfault(const char *string, const char *detailXML)
{	return ::soap_receiver_fault(this->soap, string, detailXML);
}

int managerService::soap_receiverfault(const char *subcodeQName, const char *string, const char *detailXML)
{	return ::soap_receiver_fault_subcode(this->soap, subcodeQName, string, detailXML);
}

void managerService::soap_print_fault(FILE *fd)
{	::soap_print_fault(this->soap, fd);
}

#ifndef WITH_LEAN
#ifndef WITH_COMPAT
void managerService::soap_stream_fault(std::ostream& os)
{	::soap_stream_fault(this->soap, os);
}
#endif

char *managerService::soap_sprint_fault(char *buf, size_t len)
{	return ::soap_sprint_fault(this->soap, buf, len);
}
#endif

void managerService::soap_noheader()
{	this->soap->header = NULL;
}

::SOAP_ENV__Header *managerService::soap_header()
{	return this->soap->header;
}

#ifndef WITH_NOIO
int managerService::run(int port, int backlog)
...
int managerService::ssl_run(int port, int backlog)
{	if (!soap_valid_socket(this->soap->master) && !soap_valid_socket(this->bind(NULL, port, backlog)))
		return this->soap->error;
	for (;;)
	{	if (!soap_valid_socket(this->accept()))
...
SOAP_SOCKET managerService::bind(const char *host, int port, int backlog)
{	return soap_bind(this->soap, host, port, backlog);
}

SOAP_SOCKET managerService::accept()
{	return soap_accept(this->soap);
}

#if defined(WITH_OPENSSL) || defined(WITH_GNUTLS)
int managerService::ssl_accept()
{	return soap_ssl_accept(this->soap);
}
#endif
#endif

int managerService::serve()
{
#ifndef WITH_FASTCGI
...
static int serve_ns__get_cpu_info(struct soap*, managerService*);
static int serve_ns__get_cpu_usage(struct soap*, managerService*);
static int serve_ns__get_memory_info(struct soap*, managerService*);
static int serve_ns__get_memory_available(struct soap*, managerService*);
static int serve_ns__get_memory_free(struct soap*, managerService*);
static int serve_ns__get_drive_number(struct soap*, managerService*);
static int serve_ns__get_drive_names(struct soap*, managerService*);
static int serve_ns__get_drive_info(struct soap*, managerService*);
static int serve_ns__get_drive_total_capacity(struct soap*, managerService*);
static int serve_ns__get_drive_used_capatity(struct soap*, managerService*);
static int serve_ns__get_interface_number(struct soap*, managerService*);
static int serve_ns__get_interface_names(struct soap*, managerService*);
static int serve_ns__get_interface_info(struct soap*, managerService*);
static int serve_ns__get_interface_ip_address(struct soap*, managerService*);
static int serve_ns__get_interface_speed(struct soap*, managerService*);
static int serve_ns__set_hostname(struct soap*, managerService*);
static int serve_ns__set_interface_ip_address(struct soap*, managerService*);

int managerService::dispatch()
{	return dispatch(this->soap);
}

int managerService::dispatch(struct soap* soap)
{
	managerService_init(soap->imode, soap->omode);
...
static int serve_ns__get_cpu_info(struct soap *soap, managerService *service)
...
static int serve_ns__get_cpu_usage(struct soap *soap, managerService *service)
...
static int serve_ns__get_memory_info(struct soap *soap, managerService *service)
...
static int serve_ns__get_memory_available(struct soap *soap, managerService *service)
...
static int serve_ns__get_memory_free(struct soap *soap, managerService *service)
...
static int serve_ns__get_drive_number(struct soap *soap, managerService *service)
...
static int serve_ns__get_drive_names(struct soap *soap, managerService *service)
...
static int serve_ns__get_drive_info(struct soap *soap, managerService *service)
...
static int serve_ns__get_drive_total_capacity(struct soap *soap, managerService *service)
...
static int serve_ns__get_drive_used_capatity(struct soap *soap, managerService *service)
...
static int serve_ns__get_interface_number(struct soap *soap, managerService *service)
...
static int serve_ns__get_interface_names(struct soap *soap, managerService *service)
...
static int serve_ns__get_interface_info(struct soap *soap, managerService *service)
...
static int serve_ns__get_interface_ip_address(struct soap *soap, managerService *service)
...
static int serve_ns__get_interface_speed(struct soap *soap, managerService *service)
...
static int serve_ns__set_hostname(struct soap *soap, managerService *service)
...
static int serve_ns__set_interface_ip_address(struct soap *soap, managerService *service)
